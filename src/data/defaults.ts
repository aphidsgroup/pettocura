...
export const defaultServices: ServiceItem[] = [
  {
    id: 'svc-1',
    name: 'Spa Bath',
    description: 'Perfect for regular hygiene care. Includes premium shampoo & conditioner bath, blow dry, nail clipping, and more.',
    price: '₹960',
    category: 'grooming',
    icon: '🛁',
    features: ['Shampoo & conditioner bath', 'Blow dry', 'Nail clipping', 'Ear cleaning', 'Paw cleaning & cream', 'Brushing & combing', 'Mouth spray'],
  },
  {
    id: 'svc-2',
    name: 'Bath + Basic Grooming',
    description: 'A step up for thorough care. Includes all Spa Bath features plus sanitary trim and face trimming.',
    price: '₹1440',
    category: 'grooming',
    icon: '✂️',
    features: ['Bath with shampoo & conditioner', 'Blow Dry & sanitary trim', 'Nail clipping & face trimming', 'Paw massage', 'Combing / brushing', 'Mouth spray'],
  },
  {
    id: 'svc-3',
    name: 'Full Service',
    description: 'The ultimate royal treatment. Complete body haircut, styling, and relaxing body massage.',
    price: '₹2000',
    category: 'grooming',
    icon: '👑',
    features: ['Full grooming', 'Full body haircut / styling', 'Blow Dry & sanitary trim', 'Paw massage', 'Body massage', 'Combing / brushing', 'Mouth spray'],
  },
  {
    id: 'svc-4',
    name: 'Overnight Boarding',
    description: 'Safe, comfortable & cage-free stay for all breeds with 2-3 walks daily and playtime.',
    price: '₹1300/night',
    category: 'boarding',
    icon: '🏠',
    features: ['Comfortable & Hygienic Stay', '2-3 Walks Daily', 'Playtime & Supervision', 'Fresh Water & Clean Space', 'Stress-Free Environment', 'Personalized Care'],
  },
  {
    id: 'svc-5',
    name: 'Grooming Add-ons',
    description: 'Extra care treatments to supplement your pet\'s grooming session.',
    price: 'Starts ₹300',
    category: 'grooming',
    icon: '✨',
    features: ['Tick Treatment (₹600+)', 'Dematting (₹500+)', 'Pet Taxi (₹300+)', 'Medication Care (on request)'],
  },
  {
    id: 'svc-6',
    name: 'Boarding Food Options',
    description: 'Choose between bringing your own pet food or using our premium meals.',
    price: '₹200/day',
    category: 'boarding',
    icon: '🍖',
    features: ['Owner Food - No Extra Charge', 'Our Food - ₹200 / Day', 'Fresh Water & Clean Space', 'Special Dietary Handling'],
  },
];
